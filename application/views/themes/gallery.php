        ...
        <div class="col-xs-12 col-sm-12 col-md-8">
            ...
            <div>
                ...
                <?php foreach ($have_posts as $the_post) : ?>
                    ...
                    if ($the_post["the_type"]  == "video") {
                        $the_thumbnail = $the_post['the_thumbnail'];
                    ?>


                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter <?php echo $the_post["the_tags"]; ?>">
                            <a href="javascript:void()" onclick="clickgalleryvideo('<?php echo $the_post['the_filename']; ?>','<?php echo $the_post['the_title']; ?>')"><img src="<?php echo $the_thumbnail; ?>" class="img-responsive" title="<?php echo $the_post["the_title"]; ?>"></a>
                        </div>
                    <?php
                    } else {
...
<script type="text/javascript" language="javascript">
    ...
    function clickgalleryvideo(link, title) {

        $('#gallery-show').html(
            '<div><iframe style="height:600px" width="100%" src="https://www.youtube.com/embed/'+link+'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe><br/><h5>' + title + '</h5></div>'
        );
