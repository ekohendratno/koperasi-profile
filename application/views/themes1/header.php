        ...
        <div id="topnav" class="container-fluid">
            <div class="container">
                ...
                <ul class="navbar-right">
                    <li class="nav-item"><a class="nav-link" href="<?php echo dynamic_social("SocialYoutube"); ?>"><i class="fa fa-youtube"></i></a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo dynamic_social("SocialFacebook"); ?>"><i class="fa fa-facebook-f"></i></a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo dynamic_social("SocialInstagram"); ?>"><i class="fa fa-instagram"></i></a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo dynamic_social("SocialTwitter"); ?>"><i class="fa fa-twitter"></i></a></li>
                </ul>
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>">
                    <img alt="SMKN 1 CANDIPURO" src="<?php echo base_url(); ?>assets/images/koperasi.png" style="margin-top: 10px; height: 40px">
                </a>
            </div>
